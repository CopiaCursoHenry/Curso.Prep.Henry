...
function mesesDelAño(array) {
  ...
  // Tu código:
  let mesBuscado = ["Enero", "Marzo" , "Noviembre"]
  let nuevoArray = [];
  for(let index = 0; index < array.length; index++){    
    for(let j = 0; j < mesBuscado.length; j++)
     {
        if (mesBuscado[j] == array[index])
